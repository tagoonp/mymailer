...
.custom-2::placeholder { /* Chrome, Firefox, Opera, Safari 10.1+ */
    color: #404040;
    opacity: .6; /* Firefox */
}

.custom-2:-ms-input-placeholder { /* Internet Explorer 10-11 */
    color: red;
}

.custom-2::-ms-input-placeholder { /* Microsoft Edge */
    color: red;
}
